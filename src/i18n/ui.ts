...
export const ui = {
  es: {
    ...
    'timeline.description1': 'AFA y el estudio con sede en Italia, MORQ Architecture, colaboran en The Palm Dubai - Hospitality Under Development, un plan maestro de hospitalidad que abarca un club de playa, residencias, bazar y centro de bienestar, armonizando con el paisaje árido del desierto emiratí. Este proyecto encarna el lujo a través de una propuesta de diseño reciliente y sostenible, integrándose perfectamente con los enfoques arquitectónicos audaces característicos de Dubái.',
